...
**Префікс пристрою** визначає entity ID: префікс `eveus_1` дає `sensor.eveus_1_state`, `sensor.eveus_1_currentset` тощо. Задайте його відповідно до ваших наявних автоматизацій. Префікс має бути унікальним серед ваших записів Eveus — config flow це перевіряє.

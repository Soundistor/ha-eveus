...
|-------|-------------------|------|
| `eveus_charging_started` | Зарядка входить у стан заряджання (включно з відновленням після паузи) | `entry_id`, `device_name` |
| `eveus_session_ended` | Сесія завершується (виходить зі станів заряджання/паузи) | `entry_id`, `device_name`, `energy_kwh`, `duration_s`, `ended_state`, `ended_at` |
